...
const blogImages = {
  ...
  sundayRoast: dishesImages.sundayMasalaRoast,
...
export const ImageAlts: { [K in keyof ImageRegistry]?: Record<string, string> } = {
  ...
  dishes: {
    ...
    sundayMasalaRoast: 'Sunday masala roast plated with seasonal veg',
  ...
  blog: {
    ...
    sundayRoast: 'Masala roast alternative for Sunday gatherings',
