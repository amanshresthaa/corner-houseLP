...
const mockContentData = {
  ...
  legal: {
    terms: { title: 'Terms', effectiveDate: '2025-01-01', contact: 'cornerhouse@lapeninns.com' },
    privacy: { title: 'Privacy', effectiveDate: '2025-01-01', contact: 'cornerhouse@lapeninns.com' },
  },
};
