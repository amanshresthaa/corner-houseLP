      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <p>
                <EmojiIcon emoji="📍" className="mr-1" /> {contact.address.street}, {contact.address.area},{' '}
                {contact.address.city} {contact.address.postcode}
              </p>
              <p>
                <EmojiIcon emoji="📞" className="mr-1" /> {contact.phone.display}
              </p>
              <p>
                <EmojiIcon emoji="📧" className="mr-1" /> {contact.email.primary}
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-neutral-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-4 mb-4 md:mb-0">
            ...
            <a
              href={
                footerContent.socialMedia?.instagram?.url ??
                social.instagram?.url ??
                '#'
              }
              className="text-neutral-100 hover:text-foreground-strong transition-colors"
              aria-label={
                footerContent.socialMedia?.instagram?.label ??
