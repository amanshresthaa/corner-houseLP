...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm safe-area-top">
      <div className="flex w-full flex-col bg-white">
        <SeasonalPromoBanner className="relative z-10 w-full" />
        <nav
          aria-label={navLabel}
          className="border-b border-brand-100/70 bg-white"
        >
