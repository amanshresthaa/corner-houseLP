          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <FadeInUp>
              <p className="text-lg md:text-xl text-neutral-100 max-w-3xl mx-auto leading-relaxed">
                Two sparkling nights of Nepalese curry, cheer, and live carols under our thatched roof. Join us on <strong>16 &amp; 17 December 2025</strong> for a £35 per guest festive feast—register your interest now and we&apos;ll send the full details direct.
              </p>
            </FadeInUp>
            <FadeInUp>
            ...
            <FadeIn>
              <p className="text-sm uppercase tracking-wide text-white/90">
                £35 per guest · Live carols both nights · Limited seats released soon
              </p>
            </FadeIn>
            <FadeIn>
                  ...
                  <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
                    <div className="max-w-2xl space-y-4">
                      <h2 id="curry-carols-menu-preview-heading" className="text-3xl font-display font-bold text-brand-800">
                        A taste of the 2025 Curry &amp; Carols feast
                      </h2>
                      <p className="text-lg text-brand-600 leading-relaxed">
                        Explore highlight courses from the Nepalese festive banquet below. Register your interest and our team will share the full dining experience as soon as seats are confirmed.
                      </p>
