        ...
        <section className="relative bg-gradient-to-br from-brand-600 to-brand-800 text-white py-10 md:py-16" aria-labelledby="privacy-hero-heading">
          ...
          <FadeIn>
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h1 id="privacy-hero-heading" className="h2 text-white mb-3 leading-tight">
                Privacy Policy
              </h1>
            ...
            <FadeIn>
              ...
              <article className="prose prose-lg prose-brand max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">1. Data Collection Practices</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">2. Legal Basis for Processing</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">3. Data Retention & Deletion</h2>
                    <ul className="space-y-2">
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">4. Third-Party Integrations</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">5. Your Rights Under UK GDPR</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">6. Cookie Policy & Consent Management</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">7. Data Security</h2>
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">8. International Data Transfers</h2>
                    <p className="leading-relaxed">
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">10. Updates to This Policy</h2>
                    <p className="leading-relaxed">
                  ...
                  <section>
                    <h2 className="h3 text-brand-700 mb-4">11. Contact Information & Data Protection Officer</h2>
